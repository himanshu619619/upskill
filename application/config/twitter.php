...
|
*/
$config['twitter_consumer_key']     = 'GcbUUDLW4PMz6GBHb4ZesegPU';
$config['twitter_consumer_secret']  = 's5YVyGkZSJ00H3HxgwPpvff1ZRy2gZCoL0IwKySPp1JvyAxjv8';
$config['twitter_redirect_url']     = 'twitter_authentication/';