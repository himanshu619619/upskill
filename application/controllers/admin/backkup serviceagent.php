...
//image upload
   ...
   $save = array();
      ...
      if ($fileData1['file_name']) {
        $path1 =  $fileData1;
        //                   //print_r($path);exit();
        $save['icr_picture'] = base_url() . 'uploads/product_photo/' . $path1['raw_name'] . $path1['file_ext'];
      ...
      if ($fileData2['file_name']) {
        ...
        // }
        //print_r($path);exit();
        $save['chq_picture'] = base_url() . 'uploads/product_photo/' . $path2['raw_name'] . $path2['file_ext'];
      }
      if ($fileData3['file_name']) {
        $path3 =  $fileData3;
        // }
        //print_r($path);exit();
        $save['picture_machine'] = base_url() . 'uploads/product_photo/' . $path3['raw_name'] . $path3['file_ext'];
      }
...
//image upload
 ...
 if ($fileData3['file_name']) {
        ...
        // }
        //print_r($path);exit();
        $save['dealer_invoice_pic'] = base_url() . 'uploads/product_photo/' . $path3['raw_name'] . $path3['file_ext'];
      }
