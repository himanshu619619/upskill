...
class Google_Authentication extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->facebook->is_authenticated()) {
            ...
            $userData['photo']    = !empty($fbUser['picture']['data']['url'])?$fbUser['picture']['data']['url']:'';
            ...
            if (!empty($userID)) {
                ...
                $this->session->set_userdata('serviceagentdetail', $userData);
        ...
        $this->load->view('google_authentication/index', $data);
    }
