...
<![endif]-->
    ...
    })(window, document, 'script', '<?php echo base_url('assets/backend'); ?>/www.google-analytics.com/analytics.js', 'ga');
...
<body>
    ...
    <script src="<?php echo base_url('assets/backend'); ?>/<?php echo base_url('assets/backend'); ?>/plugins/bower_components/bootstrap-extension/js/bootstrap-extension.min.js"></script>
